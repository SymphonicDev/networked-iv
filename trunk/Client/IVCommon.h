...
#define PAD(name, size) BYTE name[size]
...
struct Matrix34
{
	Vector3 vecRight;		// 00-0C // Roll
	DWORD	dwPadRight;		// 0C-10 // Roll
	Vector3	vecFront;		// 10-1C // Direction
	DWORD	dwPadFront;		// 1C-20 // Direction
	Vector3	vecUp;			// 20-2C
	DWORD	dwPadUp;		// 2C-30
	Vector3	vecPosition;	// 30-3C // Position
	DWORD	dwPadPosition;	// 3C-40 // Position
};
