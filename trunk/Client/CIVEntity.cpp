...
void CIVEntity::SetMatrix(Matrix34 * matMatrix)
{
	if(m_pEntity && m_pEntity->m_pMatrix)
		memcpy(m_pEntity->m_pMatrix, matMatrix, sizeof(Matrix34));
}

void CIVEntity::GetMatrix(Matrix34 * matMatrix)
{
	if(m_pEntity && m_pEntity->m_pMatrix)
		memcpy(matMatrix, m_pEntity->m_pMatrix, sizeof(Matrix34));
}
