...
CTimer::CTimer(CResource* pResource, SQObjectPtr pFunction, unsigned long ulInterval, unsigned int uiAmountRepeating, CSquirrelArguments* pArguments) : CEntity(CEntity::TIMER, pResource, "timer")
{
